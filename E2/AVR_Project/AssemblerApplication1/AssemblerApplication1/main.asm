...
main:	cli			; initialize stack
	...
	ldi YH, $01		; expand key to the memory
	ldi YL, $00		; locations $100..$100+(16*11-1)
	rcall key_expand
	...
	ldi YH, 0x01		; initialize YH:YL to
	ldi YL, 0x00		; expanded key and call
	rcall encrypt		; encryption routine

	; now the registers ST11-ST44 contain the enciphered text

	ldi YH, high($100+16*11) ; initialize YH:YL to point BEHIND 
	ldi YL, low($100+16*11)	; decryption key material and
...
.db $e0,$e2,$e4,$e6,$e8,$ea,$ec,$ee,$f0,$f2,$f4,$f6,$f8,$fa,$fc,$fe ; 0x1111 1110 << 2 = 1 1111 1100 % 0000 0001 0001 1011 
